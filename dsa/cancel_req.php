...
<div  class="container">
<p > Cancelling a booked accommodation </p>

<div class="container three">
  <div class="row text-center four nine ">

  <div class="col-sm-12"><p>Details</p></div>
...
<br/>
 ...
 $mysqlPassword = "meera";
  ...
  $sql="select * from guestdetails2 where gid=$_REQUEST[ttgid];"
    ...
    echo "No data found!";
      ...
      $trow = mysql_fetch_array($tresult);
        ...
        ?>
                    ...
                    <div class="col-sm-5">Guest_ID</div>
					<div class="col-sm-2">:</div>
					<div class="col-sm-5"><?php echo  $gid;  ?></div>
					</div>
          ...
          <br/>
					...
					<div class="col-sm-2">:</div>
					<div class="col-sm-5"><?php echo  $name;  ?></div>
					</div>
          ...
          <br/>
					...
					<div class="row text-center four">
                    <div class="col-sm-5">Arrival Date</div>
					<div class="col-sm-2">:</div>
					<div class="col-sm-5"><?php echo  $arrival_1;  ?></div>
					</div>

          <br/>

					<div class="row text-center four">
                    <div class="col-sm-5">Departure Date</div>
					<div class="col-sm-2">:</div>
					<div class="col-sm-5"><?php echo  $departure_1;  ?></div>
					</div>

          <br/>

					<div class="row text-center four">
                    	<div class="col-sm-5">Cancel</div>
						<div class="col-sm-2">:</div>
							<div class="col-sm-5">
          ...
          <br/>
					...
					<div class="row text-center four">
                    <div class="col-sm-5">Reason for Cancelling</div>
					<div class="col-sm-2">:</div>
					<div class="col-sm-5"><input name="reason1"  id="reason1" size="40" maxlength="40" required></div>
					</div>

          <br/>

					<?php
					//passing which gid to be cancelled to viewrequest.php
					echo "<input type=\"hidden\" name=\"tgidno\" value=\"$gid\"" ;
					?>

				    <div class="row text-center four">
                    <div class="col-sm-0"><input type="hidden" name="submitted_for" value="cancel_request"></div>

			                <div class="col-sm-12 text-center" ><input name="Submit_Can" type="submit"  value="UPDATE"></div>
        <!--  <div class="text-center">

          <button type="button" name="Submit_Can" class="btn btn-primary" id="Submit_Can" >Update</button>
        </div>-->
					</div>
...
<div class="row">
    ...
    <div class="col-md-4 text center nine ten ">
