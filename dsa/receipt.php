...
<div class="container three">
  ...
  <div class="col-sm-2">Generate Receipt </div>
    ...
    if ($status=="BOOKED" ) //booked IN ROOM_STATUS
      {
        ...
        ?>
                    ...
                    <div class="col-sm-1"><?php echo  $i;  ?></div>
				          	...
				          	<div class="col-sm-2"><?php echo  $name;  ?></div>
                    ...
                    <div class="col-sm-2"><a href="receipt_gen.php?ttgid=<?php echo $gid; ?>" title="Request lr." target="_blank">  Click here</a></div>
