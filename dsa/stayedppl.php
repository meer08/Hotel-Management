...
<div class="container three">
  ...
  <div class="col-sm-3">Arrival Date</div>
  <div class="col-sm-3">Departure Date</div>
  <div class="col-sm-2">Room type</div>
  <div class="col-sm-1">Room number</div>
  ...
  if($num==0)
  {
    echo "No data found!";
      ...
      {  $i++;
		...
		or die("Can't execute room_status!!");
...
if ($status=="BOOKED" ) //booked IN ROOM_STATUS
{
    ...
    $sql3="select * from room_status where GID='$gid'"
		or die("Can't execute personid!!");

		$tresult3=mysql_query($sql3,$conn);
		$num3=mysql_num_rows($tresult3);
		//echo "num2=".$num2;
		$trow3 = mysql_fetch_array($tresult3);
		$troomid=$trow3['ROOMID'];
...
//    echo "room no".$troomno;
        ...
        ?>
                    ...
                    <div class="col-sm-3"><?php echo $departure_1;?></div>
					          <div class="col-sm-2"><?php echo $room_type;?></div>
                    <div class="col-sm-1"><?php echo $troomno;?></div>
