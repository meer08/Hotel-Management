...
//  $mysqlPassword = "nazarene";
  ...
  //To enter the data into mysql
   ...
   //echo "arrival= ".$arrival;
    $room_type = $_POST['room_type'];
	  ...
	  //first check wtr the request dates are in blocked_dates
	  $sel1 = mysql_select_db("blocked_dates",$conn);//Selecting the database
      $blocked_COUNT_SQL="SELECT * FROM blocked_dates WHERE from_date>='$arrival' and to_date<='$departure' and status=' '";
      $blocked_rs =@mysql_query($blocked_COUNT_SQL,$conn) or die ("could not execute blocked COUNT FROM MASTER -- SQL query");
      $blockcount= mysql_num_rows($blocked_rs);
  ...
  } // block  count / block date count if ends


  else
  {
	  echo "<h4><font color=\'blue\'> <p>Sorry, all rooms reserved on the given dates.., please try with other dates...</p> </font></h4>";
  }
             ...
             <!--     <td><input type="text" name="name[]" placeholder="Enter your Name" class="form-control name_list" /></td> -->
              ...
              <div class="col-md-5">
                   <select name="room_type" class="suit-select input-field" name="room_type" id="room_type" >
                       ...
                       <option value="tripe">Triple</option>
